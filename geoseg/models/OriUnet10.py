...
class MyUNet(nn.Module):
    def __init__(self, n_classes, backbone='resnet18'):
        ...
        self.cab1 = CAB(128, 64)
        self.cab2 = CAB(256, 128)
        self.cab3 = CAB(512, 256)
        self.cab4 = CAB(1024, 512)
    ...
    def forward(self, x):
        ...
        r1 = self.rrb1(torch.cat([c1, r1], dim=1))
        r2 = self.rrb2(torch.cat([c2, r2], dim=1))
        r3 = self.rrb3(torch.cat([c3, r3], dim=1))
        r4 = self.rrb4(torch.cat([c4, r4], dim=1))
