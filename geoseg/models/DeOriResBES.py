...
class PAM_Module(nn.Module):
    def __init__(self, in_places, scale=8, eps=1e-6):
        ...
        self.softplus_feature = nn.functional.softplus
        self.eps = eps
...
class BESNet(nn.Module):
    def __init__(self, nclass, backbone='resnet18', aux=True, norm_layer=nn.BatchNorm2d, pretrained=True):
        ...
        self.BoundaryExtraction = BE_Module(64, 128, 512, 64, 128, 1)  # in_ch1, in_ch2, in_ch5, mid_ch, out_ch, n_class
        ...
        self.attention4 = PAM_Module(128)
        self.attention3 = PAM_Module(256)
        self.attention2 = PAM_Module(512)

        self.decoder4 = DecoderBlock(128, 256)
        self.decoder3 = DecoderBlock(256, 512)
        self.decoder2 = DecoderBlock(512, 1024)
    ...
    def forward(self, x):
        ...
        size1 = c1.size()[2:]
        b, c_boundaryloss = self.BoundaryExtraction(c1, c2, c4)
        ...
        # x = self.decoder4(x)+self.attention4(c2)
        # x = self.decoder3(x)+self.attention3(c3)
        # x = self.decoder2(x)+self.attention2(c4)
