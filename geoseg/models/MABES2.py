...
from backbones.blurresnet_for_bes import FCNHead, UP_Conv, resnet18
...
class BESNet(nn.Module):
    def __init__(self, nclass, backbone='resnet18', aux=True, norm_layer=nn.BatchNorm2d, pretrained=False):
        super(BESNet, self).__init__()

        self.aux = aux  # 辅助loss
        resnet = eval(backbone)(pretrained=False)
