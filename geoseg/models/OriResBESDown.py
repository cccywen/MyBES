...
class BE_Module(nn.Module):
    def __init__(self, in_ch1, in_ch2, in_ch5, mid_ch, out_ch, n_class):
        ...
        self.down = nn.Conv2d(mid_ch, mid_ch,kernel_size=2, stride=2)
        self.convb_1 = ConvBnReLU(in_ch1, mid_ch, kernel_size=1, stride=2, padding=0, dilation=1)  # 用来统一channel
        self.convb_2 = ConvBnReLU(in_ch2, mid_ch, kernel_size=1, stride=2, padding=0, dilation=1)
    ...
    def forward(self, l1, l2, l5):
        ...
        l5_b = F.interpolate(l5_b, l2_b.size()[2:], mode='bilinear', align_corners=True)
...
class MSF_Module(nn.Module):
    def __init__(self, in_ch, mid_ch1, cat_ch, mid_ch2, out_ch):
        ...
        self.input2 = ConvBnReLU(in_ch[1], mid_ch1, kernel_size=1, stride=2, padding=0, dilation=1)
