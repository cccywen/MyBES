...
from backbones.resnet_for_bes import FCNHead, UP_Conv

# 尺寸不匹配时用上采样 BE模块不加f4高级特征 backbone resnet50 上采样用decoder
...
class BESNet(nn.Module):
    def __init__(self, nclass, backbone='resnet50', aux=True, norm_layer=nn.BatchNorm2d, pretrained=True):
        ...
        self.BoundaryExtraction = BE_Module(64, 128, 64, 128, 1)  # in_ch1, in_ch2, mid_ch, out_ch, n_class
