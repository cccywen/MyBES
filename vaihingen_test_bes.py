...
import time
# from train_supervision import *  # 原来的loss
from train_supervision_bes import *  # 新的loss（加boundary loss的
...
def get_args():
    ...
    arg("-o", "--output_path", type=Path, help="Path where to save resulting masks.", default="fig_results/vaihingen/manet")
...
def main():
    ...
    config = py2cfg("/home/caoyiwen/slns/GeoUnetformer/config/vaihingen/mabes_bl.py")
