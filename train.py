...
from tools.visiable import visualize_feature_map
import random
...
class Supervision_Train(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        img_name = batch['img_id']
        visualize_feature_map(pre[1], img_name)
...
def main():
    ...
    config = py2cfg("/home/caoyiwen/slns/MyBES/config/vaihingen/bes_v.py")
