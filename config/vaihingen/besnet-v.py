...
classes = CLASSES
weights_name = "bes-test-e200"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "bes-test-e200"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/MyBES/model_weights/vaihingen/bes-orimabes--e150/bes-orimabes--e150-v4.ckpt'
