...
from geoseg.models.OriResBESDown import BESNet
...
classes = CLASSES
weights_name = "bes-orires-down-e100"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "bes-orires-down-e100"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/MyBES/model_weights/vaihingen/mabesa-e150/mabesa-e150-v3.ckpt'
