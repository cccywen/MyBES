...
from geoseg.datasets.vaihingen_dataset_v import *
# from geoseg.models.MALST import MANet
from geoseg.models.OriResBES import BESNet
...
classes = CLASSES
weights_name = "orimabes-v-e50"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "oribes-v-e50-v3"
...
gpus = [0]
strategy = None
pretrained_ckpt_path = '/home/caoyiwen/slns/MyBES/model_weights/vaihingen/orimabes-v-e50/oribes-v-e50-v3.ckpt'
...
val_dataset = VaihingenDataset(data_root='/home/caoyiwen/data/vaihingen/val', img_dir='images_1024', mask_dir='masks_1024', img_size=(1024, 1024),
                               transform=val_aug)
test_dataset = VaihingenDataset(data_root='/home/caoyiwen/data/vaihingen/v_test', img_dir='images_1024', mask_dir='masks_1024', img_size=(1024, 1024),
                                transform=val_aug)
