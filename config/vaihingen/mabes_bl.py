...
from geoseg.models.MABES import BESNet
...
classes = CLASSES
weights_name = "mabes-bloss-e150"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "mabes-bloss-e150-v2"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/GeoUnetformer/model_weights/vaihingen/mabes-wbloss-e150/mabes-wbloss-e150.ckpt'
