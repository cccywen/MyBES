...
from geoseg.models.OriUnet12 import MyUNet
...
classes = CLASSES
weights_name = "oriunet12-new-e150"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "oriunet12-new-e150-v2"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/MyBES/model_weights/vaihingen/oriunet4-check3-e150/oriunet4-check3-e150-v2.ckpt'
