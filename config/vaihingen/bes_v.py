...
from geoseg.models.ASFBES import BESNet
...
classes = CLASSES
weights_name = "asfbes-vnew-e50"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "asfbes-vnew-e50-v2"
...
gpus = [0]
strategy = None
pretrained_ckpt_path = '/home/caoyiwen/slns/MyBES/model_weights/vaihingen/asfbes-vnew-e50/asfbes-vnew-e50-v6.ckpt'
