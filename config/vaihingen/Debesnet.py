...
from geoseg.models.DeOriResBES import BESNet
...
classes = CLASSES
weights_name = "debes-res50-benof5-e100"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "debes-res50-benof5-e100"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/MyBES/model_weights/vaihingen/bes-orires-benof5-e150//bes-orires-benof5-e150.ckpt'
