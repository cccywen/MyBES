...
from geoseg.models.MyUnetttt import MyUNet
...
classes = CLASSES
weights_name = "unet1-test-e150"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "unet1-test-e150"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/MyBES/model_weights/vaihingen/bes-test-e200/bes-test-e200.ckpt'
...
from geoseg.losses import *
from geoseg.datasets.vaihingen_dataset import *
# from geoseg.models.MyBES import BESNet
...
num_classes = len(CLASSES)
classes = CLASSES
weights_name = "unet-test-e150"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "unet-test-e150"
log_name = 'vaihingen/{}'.format(weights_name)
monitor = 'val_F1'
monitor_mode = 'max'
save_top_k = 3
