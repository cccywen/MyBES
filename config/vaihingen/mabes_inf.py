...
from geoseg.models.MABES_inf import BESNet
...
classes = CLASSES
weights_name = "mabes-2pamcat-bloss-e150"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "mabes-2pamcat-bloss-e150-v2"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/MyBES/model_weights/vaihingen/mabes-2pamcat-e150/mabes-2pamcat-e150-v1.ckpt'
