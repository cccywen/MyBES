...
from geoseg.models.BESNet import BESNet
...
classes = CLASSES
weights_name = "mabes-wbloss-e150"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "mabes-wbloss-e150"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/GeoUnetformer/model_weights/vaihingen/mabes-2pamcat-e150/mabes-2pamcat-e150-v1.ckpt'
...
ori_loss = JointLoss(SoftCrossEntropyLoss(smooth_factor=0.05, ignore_index=ignore_index), DiceLoss(smooth=0.05, ignore_index=ignore_index), 1.0, 1.0)
b_loss = BoundaryLoss()
